<?php
namespace App\Lib\Common\Paging;
...
class WebPaging
{
    ...
    public $befor_img1='/img/common/board/btn_before1.gif';
    public $befor_img2='/img/common/board/btn_before2.gif';
    public $after_img1='/img/common/board/btn_after1.gif';
    public $after_img2='/img/common/board/btn_after2.gif';
