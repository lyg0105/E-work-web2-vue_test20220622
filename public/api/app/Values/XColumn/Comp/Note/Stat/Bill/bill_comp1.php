...
[
    ...
    'note_end_name'=>array('name'=>'하차지','type'=>'varchar','length'=>'30','pri'=>'','width'=>'60'),
    'note_req_car_type'=>array('name'=>'차종','type'=>'varchar','length'=>'30','pri'=>'','width'=>'60'),
    'note_req_car_ton'=>array('name'=>'톤수','type'=>'float','length'=>'','pri'=>'','width'=>'60'),
    'note_alloc_car_num'=>array('name'=>'차량번호','type'=>'varchar','length'=>'20','pri'=>'','width'=>'110'),
    'note_alloc_car_user_name'=>array('name'=>'차주명','type'=>'varchar','length'=>'30','pri'=>'','width'=>'70'),
    'note_cargo_name'=>array('name'=>'화물명','type'=>'varchar','length'=>'50','pri'=>'','width'=>'60'),
    'note_supply_money'=>array('name'=>'공급가액','type'=>'int','length'=>'','pri'=>'','width'=>'70'),
    'note_supply_money_add'=>array('name'=>'추가금액','type'=>'int','length'=>'','pri'=>'','width'=>'50'),
    'note_st_end_distance'=>array('name'=>'거리','type'=>'double','length'=>'','pri'=>'','width'=>'50'),

    'note_cargo_ton'=>array('name'=>'화물무게','type'=>'float','length'=>'','pri'=>'','width'=>'100','is_use'=>''),
    'note_is_pre_pay'=>array('name'=>'선착불여부','type'=>'varchar','length'=>'1','pri'=>'','width'=>'100','is_use'=>''),
    'note_pay_type'=>array('name'=>'운송비구분','type'=>'varchar','length'=>'20','pri'=>'','width'=>'100','is_use'=>''),
    'note_pay_money'=>array('name'=>'운송료','type'=>'int','length'=>'','pri'=>'','width'=>'100','is_use'=>''),
    ...
    'note_places'=>array('name'=>'경유지','type'=>'varchar','length'=>'100','pri'=>'','width'=>'100','is_use'=>''),
