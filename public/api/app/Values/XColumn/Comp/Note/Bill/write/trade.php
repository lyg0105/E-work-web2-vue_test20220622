...
[
    ...
    'trade_subject_name'=>array('name'=>'계정과목','type'=>'varchar','length'=>'30','pri'=>'','width'=>'120'),
    ...
    // 'row_view_cust_name'=>array('name'=>'거래처','type'=>'varchar','length'=>'20','pri'=>'','width'=>'110'),
    'trade_memo'=>array('name'=>'적요','type'=>'varchar','length'=>'100','pri'=>'','width'=>'160'),
    'trade_money'=>array('name'=>'금액','type'=>'int','length'=>'','pri'=>'','width'=>'100'),
    // 'row_view_debit_credit'=>array('name'=>'차변대변','type'=>'varchar','length'=>'10','pri'=>'','width'=>'100'),
...
$this->x_view_col_arr=['row_view_cust_name','row_view_debit_money','row_view_credit_money','row_view_par_name','row_view_debit_credit'];
$this->select_col_arr=[
    'trade_debit_credit'=>[
        ['text'=>'차변','value'=>'debit'],
...
$this->is_number_col_arr=[
    'trade_money',
    'row_view_debit_money',
    'row_view_credit_money'
];
$this->is_tel_col_arr=[];
