...
[
    ...
    // 'note_memo2'=>array('name'=>'비고','type'=>'varchar','length'=>'200','pri'=>'','width'=>'100'),
    // 'note_memo3'=>array('name'=>'메모','type'=>'varchar','length'=>'200','pri'=>'','width'=>'100'),
...
$this->x_view_col_arr=['note_supply_money_add','note_pay_money_add'];
$this->select_col_arr=[
    'note_cust_sort'=>[
        ['text'=>'화주사','value'=>'1'],
        ['text'=>'운송사','value'=>'2']
