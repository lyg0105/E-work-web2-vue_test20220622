...
[
    ...
    'userlist_pwd'=>array('name'=>'암호','type'=>'varchar','length'=>'14','pri'=>'','width'=>'100'),
    ...
    'jasa_code'=>array('name'=>'자사','type'=>'varchar','length'=>'14','pri'=>'','width'=>'100'),
    ...
    'sawon_email'=>array('name'=>'사원이메일','type'=>'varchar','length'=>'320','pri'=>'','width'=>'100'),
    ...
    // 'sawon_sugub'=>array('name'=>'사원구분','type'=>'varchar','length'=>'1','pri'=>'','width'=>'100'),
...
$this->x_view_col_arr=['userlist_id'];
...
$this->is_password_col_arr=['userlist_pwd'];
